...
function countingOne(event)
{

    var title = event.currentTarget;
    var remaining = document.getElementById("remLen1");
    textCounter(title,remaining,128);



}

function countingTwo(event)
{
    var description = event.currentTarget;
    var remaining = document.getElementById("remLen2");
    textCounter(description,remaining,512);
}
...
function validate_image()
{
      ...
      //  alert(image);
        //var image_length = document.getElementById("imageFile").length;
        var advice = document.getElementById("imageadvice");
        var str;

        if(image == "null" || image  == '')
        {
            //alert("reach1");
            str = "Please select a jpeg Image";
    ...
    // alert("reach2");
    str = "You must upload a jpeg/jpg image file";
    advice.innerHTML = str;
    advice.style.visibility = "visible";
    event.preventDefault();
    return false;
